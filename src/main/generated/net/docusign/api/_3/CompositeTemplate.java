...
public class CompositeTemplate {
    ...
    /**
     * If supplied the template will be pulled from the PDF metadata and applied, if exists
     * 
     * @return
     *     possible object is
    ...
    public static class InlineTemplates {
        ...
        @XmlElement(name = "InlineTemplate", required = true)
    ...
    public static class ServerTemplates {
        ...
        @XmlElement(name = "ServerTemplate", required = true)
