...
import net.docusign.api._3.DocumentField;
import net.docusign.api._3.MatchBox;
 ...
 *         &lt;element name="Password" type="{http://www.docusign.net/API/3.0}Password" minOccurs="0"/>
 *         &lt;element name="TransformPdfFields" type="{http://www.w3.org/2001/XMLSchema}boolean" minOccurs="0"/>
 *         &lt;element name="FileExtension" type="{http://www.docusign.net/API/3.0}LongString" minOccurs="0"/>
 *         &lt;element name="MatchBoxes" minOccurs="0">
 *           &lt;complexType>
 *             &lt;complexContent>
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element ref="{http://www.docusign.net/API/3.0}MatchBox" maxOccurs="unbounded"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="AttachmentDescription" type="{http://www.docusign.net/API/3.0}LongString" minOccurs="0"/>
...
public class Document {
    ...
    protected Document.MatchBoxes matchBoxes;
    @XmlElement(name = "AttachmentDescription")
    protected String attachmentDescription;
    @XmlElement(name = "DocumentFields")
    protected Document.DocumentFields documentFields;
     ...
     * @return
     *     possible object is
     *     {@link Document.MatchBoxes }
     *     
     */
    public Document.MatchBoxes getMatchBoxes() {
        return matchBoxes;
    }
     ...
     *     
     */
    public void setMatchBoxes(Document.MatchBoxes value) {
     ...
     * @return
     *     possible object is
     *     {@link Document.DocumentFields }
     *     
     */
    public Document.DocumentFields getDocumentFields() {
     ...
     *     
     */
    public void setDocumentFields(Document.DocumentFields value) {
    ...
    public static class DocumentFields {
        ...
        @XmlElement(name = "DocumentField", namespace = "http://www.docusign.net/API/3.0", required = true)
    ...
    public static class MatchBoxes {

        @XmlElement(name = "MatchBox", namespace = "http://www.docusign.net/API/3.0", required = true)
